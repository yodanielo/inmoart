            ...
            <div id="content" class="content_<?php echo stripslashes(get_option('ptthemes_sidebar_left'));  ?>">
                ...
                <span class="error_msg">Please Enter Username </span><?php */?>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <?php/*
                <span class="fl user_define"><input name="proprty_type" type="radio"  <?php if($proprty_type=='Sale') {
                        echo 'checked="checked"';
                                                    }?> value="Sale" /> <?php _e(SALE_TEXT);?></span>
                <span class="fl user_define"> <input name="proprty_type" type="radio" <?php if($proprty_type=='Rent') {
                        echo 'checked="checked"';
                                                     }?> value="Rent" /> <?php _e(RENT_TEXT);?> </span>
                <span class="fl user_define"> <input name="proprty_type" type="radio" <?php if($proprty_type=='New Build') {
                        echo 'checked="checked"';
                                                    }?> value="New Build" /> <?php _e(NEWBUILD_TEXT);?> </span>
                                */?>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_bedroom_span"></span>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_sqft_span"></span>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_location_span"></span>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_address_span"></span>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_view_span"></span>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_city_span"></span>
                    </div>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_state_span"></span>
                    </div>
                    <div class="form_row clearfix " style="display:none">
                        ...
                        <span class="message_error2" id="proprty_country_span"></span>
                    </div>
...
<span id="<?php echo 'span_'.$property_price_info[$p]['title'];?>"> <?php echo get_currency_sym();?><?php echo $property_price_info[$p]['price'];?> (for <?php echo $property_price_info[$p]['days'];?><?php echo $property_price_info[$p]['day_type'];?>)</span>
                    ...
                    <div class="form_row clearfix">
                        ...
                        <span class="message_error2" id="proprty_label_span"></span>
                    </div>
