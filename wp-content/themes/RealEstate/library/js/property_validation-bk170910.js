...
//On Submitting
	propertyform.submit(function(){
		if(validate_proprty_name() & validate_proprty_location() & validate_proprty_address() & validate_proprty_city() & validate_proprty_state() & validate_proprty_country() & validate_proprty_zip() & validate_proprty_bedroom() & validate_proprty_sqft() & validate_proprty_pricerange() & validate_proprty_price() & validate_proprty_type() & validate_proprty_desc())
			return true
		else
			return false;
	});
