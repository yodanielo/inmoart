...
?>
        ...
        if(!is_home()) {
            ...
            <div id="banderitascont">
                ...
                ?>
                <?php /*<a id="banin" href="javascript:chlang('en')"><img src="<?php bloginfo('siteurl')?>/wp-content/themes/RealEstate/images/flag-eng.png"/></a>
                <a id="banes" href="javascript:chlang('es')"><img src="<?php bloginfo('siteurl')?>/wp-content/themes/RealEstate/images/flag-esp.png"/></a>
                <a id="banal" href="javascript:chlang('al')"><img src="<?php bloginfo('siteurl')?>/wp-content/themes/RealEstate/images/flag-ale.png"/></a>
                <a id="banho" href="javascript:chlang('ho')"><img src="<?php bloginfo('siteurl')?>/wp-content/themes/RealEstate/images/flag-hol.png"/></a>
                <a id="banda" href="javascript:chlang('da')"><img src="<?php bloginfo('siteurl')?>/wp-content/themes/RealEstate/images/flag-din.png"/></a>
                 */?>
            ...
            <div id="banprincont">
                            ...
                            <li class="<?php if($_REQUEST['page']=='agents') {
                                ...
                                <?php if ( get_option('ptthemes_blogcategory') <> "" ) { ?>
                                    ...
                                    if($catid) {
                                        ...
                                        wp_list_categories ('title_li=&depth=0&include=' . $catid . '&sort_column=menu_order&show_option_all=true');
                                    }
                                    ?>
             ...
             <script type="text/javascript">
                 ...
                 jQuery("a:contains('true')").parent().remove();
            </script>
