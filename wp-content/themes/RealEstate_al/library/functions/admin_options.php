...
$options[] = array(	"label" => "Show \"New Builds\" link in main menu?",
        "desc" => "",
        "id" => $shortname."_newbuild_link_flag",
        "std" => "true",
        "type" => "checkbox");
...
$options[] = array(	"name" => "Options of Type",
        "type" => "heading");
$options[] = array(	"name" => "Options of Type",
        "toggle" => "true",
        "type" => "subheadingtop");
$options[] = array(	"name" => "Meta Description",
        "desc" => "Las opciones del campo Type en las propiedades<br/>Ingrese una opción por línea",
        "id" => $shortname."_type_options",
        "std" => "",
        "type" => "textarea");
$options[] = array(	"type" => "subheadingbottom");
...
$options[] = array(	"name" => "Options of View",
        "type" => "heading");
$options[] = array(	"name" => "Options of View",
        "toggle" => "true",
        "type" => "subheadingtop");
$options[] = array(	"name" => "Meta Description",
        "desc" => "Las opciones del campo View en las propiedades<br/>Ingrese una opción por línea",
        "id" => $shortname."_view_options",
        "std" => "",
        "type" => "textarea");
$options[] = array(	"type" => "subheadingbottom");
...
$options[] = array(	"name" => "Options of Label",
        "type" => "heading");
$options[] = array(	"name" => "Options of Label",
        "toggle" => "true",
        "type" => "subheadingtop");
$options[] = array(	"name" => "Meta Description",
        "desc" => "Las opciones del campo Label en las propiedades<br/>Ingrese una opción por línea",
        "id" => $shortname."_label_options",
        "std" => "",
        "type" => "textarea");
$options[] = array(	"type" => "subheadingbottom");
...
$options[] = array(	"name" => "Number of 'Latest Properties' to be shown in the slider",
        "toggle" => "true",
        "type" => "subheadingtop");
