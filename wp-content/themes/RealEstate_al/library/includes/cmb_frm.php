...
if($_POST)
{
	$yourname = $_POST['cmb_name'];
	$yourphone = $_POST['cmb_phone'];
...
/*	echo "From : $youremail  Name : $yourname <br>";
	...
	echo "$client_message";
	exit;*/
	sendEmail("info@inmoart.co.uk",$yourname,"info@inmoart.co.uk",get_option("blogname"),"Call me back","Hi, my name is ".$yourname.". Please call me back at the number ".$yourphone.".",$extra='');///To clidne email
	//////Inquiry EMAIL END////////
}
?>