        ...
        <div class="bottompart">
            ...
            <div class="aboutus">
                ...
                <div class="widget">
                    ...
                    <h3>Acerca de Inmoart</h3>

                    <p>

                        Somos expertos fiscales y oficiales de Bienes Raíces

                        Agentes, el ancho más de 20 años de negocios

                        experiencia en esta área. Básicamente estamos

                        profesionales que puede confiar.
...
<?php wp_footer(); ?><?php
                if (get_option('ptthemes_google_analytics') <> "") {
