...
<div class="options">
    ...
    <div class="rental">
        <div id="rentaltitle"><img id="rentalico" src="<?php bloginfo('template_directory'); ?>/images/ico-need-help.png"/><span>Necesita Ayuda?</span></div>
        <?php
            global $wpdb;
...
<div class="widget">
    ...
    <div class="shlist">
                    ...
                    if(count($post_ids)>0 && !$current_user->data->ID=='') {
                        $sql="select * from $wpdb->posts where post_status = 'publish' and id in (".implode($post_ids,",").") and post_type = 'post'";
