...
?>
 ...
 <div class="wrapper" >
		<div class="clearfix container_message">
            	<h1 class="head2"><?php _e(AUTHORISE_NET_MSG);?></h1>
            </div>
...
$user_phone = $current_user->data->user_phone;
...
if($paymentFlag == 0)
{
	 wp_redirect(get_option('siteurl')."/?page=checkout");
	 exit;
}
...
//if(!$paymentFlag)
//{
	//wp_redirect(get_option('siteurl').'/?page=checkout&paymentmethod='. $_REQUEST['paymentmethod'].'&shippingmethod='.$_REQUEST['shippingmethod']);
	//exit;
//}
?>