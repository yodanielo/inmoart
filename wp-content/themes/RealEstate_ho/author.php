                    ...
                    <?php
                                            if ($current_user->data->ID == $curauth->ID) {
                                                if ($_REQUEST['list'] == 'favourite') {
                                                    ...
                                                    if ($_GET["mlsno"]) {
                                                        $mlsql="select post_id from $wpdb->postmeta where meta_key like 'mlsno' and meta_value like '%".$_GET["mlsno"]."%'";
                                                        $mlsno_arr = $wpdb->get_col($mlsql);
                                                        //print_r($mlsno_arr);
                                                        $querypost['post__in'] = $mlsno_arr;
